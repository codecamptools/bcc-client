<template>
  <div>
    ...
    <div class="row">
      <div class="col-sm-4">
        <ul
          class="text-light border-primary p-1 card list-unstyled"
        ...
        >
          ...
          <li class="list-group-item">
            <a href="#games">Game Dev, Media &amp; Entertainment</a>
          </li>
          <li class="list-group-item">
            <a href="#cloud">Infrastructure, Dev Ops &amp; Cloud</a>
          </li>
        </ul>
      </div>
      <div class="component-tabs--main col-xs-12 col-sm-offset-1 col-sm-8">
        <div>
          <div>
            <div
